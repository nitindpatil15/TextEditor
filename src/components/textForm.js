  ...
  return (
    <>
      <div className="container" style={{color: props.mode === "light" ? "black" : "grey",}} >
        ...
        <button className="btn btn-primary my-4 mx-2" onClick={handleLOcase}> Convert to Lowercase </button>
        <button className="btn btn-primary my-4 mx-2" onClick={handleremove}> remove </button>
        <button className="btn btn-primary my-4 mx-2" onClick={handlecopy}> Copy Text </button>
        <button className="btn btn-primary my-4 mx-2" onClick={handleExtraSpace} > Remove Extra spaces </button> 
        </div>
